...
export type GetNotificationCountsQuery = { readonly __typename: 'Query', readonly viewer?: { readonly __typename: 'User', readonly id: string, readonly name: string, readonly newMessagesCount: number, readonly newNotificationsCount: number, readonly friendRequestsReceived: { readonly __typename: 'UserConnection', readonly totalCount: number } } | null };
