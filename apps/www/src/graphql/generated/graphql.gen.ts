...
export const UserActivityCardHeaderUserActivityFragmentDoc = /*#__PURE__*/ gql`
  ...
  userId
    ...
    `;
export const UserActivityCardCommentPostFragmentDoc = /*#__PURE__*/ gql`
    fragment UserActivityCardCommentPost on UserActivityCommentPost {
  id
  comment {
    id
    post {
