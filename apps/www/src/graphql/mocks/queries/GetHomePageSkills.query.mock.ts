import { GetHomePageSkillsQuery } from "../../generated";

export const GetHomePageSkills_mock: GetHomePageSkillsQuery = {
	__typename: "Query",
	github: {
		__typename: "GitHub",
		react: {
		...
		urql: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnkxMTg2OTUzMDY=",
			name: "urql",
			owner: {
				__typename: "GitHubOrganization",
		...
		nexus: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnkxNTU5MjE5Nzg=",
			name: "nexus",
			owner: {
				__typename: "GitHubOrganization",
		...
		motion: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnkxNTc4NDY4NzY=",
			name: "motion",
			owner: {
				__typename: "GitHubOrganization",
		...
		apolloServer: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnk1Njc2MDYzMw==",
			name: "apollo-server",
			owner: {
				__typename: "GitHubOrganization",
		...
		postgres: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnk5Mjc0NDI=",
			name: "postgres",
			owner: {
				__typename: "GitHubOrganization",
		...
		tailwindcss: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnkxMDYwMTczNDM=",
			name: "tailwindcss",
			owner: {
				__typename: "GitHubOrganization",
		...
		expo: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnk2NTc1MDI0MQ==",
			name: "expo",
			owner: {
				__typename: "GitHubOrganization",
		...
		supabase: {
			__typename: "GitHubRepository",
			id: "MDEwOlJlcG9zaXRvcnkyMTQ1ODcxOTM=",
			name: "supabase",
			owner: {
				__typename: "GitHubOrganization",
