...
export interface CodeExampleMiniCardProps {
	className?: string;
	codeExample: CodeExampleCardCodeExampleFragment;
	style?: CSSProperties;
}

export const CodeExampleMiniCard = forwardRef<HTMLDivElement, CodeExampleMiniCardProps>(
	(props, ref) => {
...
CodeExampleMiniCard.displayName = "CodeExampleMiniCard";
