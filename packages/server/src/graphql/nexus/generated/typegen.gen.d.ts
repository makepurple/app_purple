...
export interface NexusGenObjects {
  ...
  CreateExperiencePayload: { // root type
    errors?: NexusGenRootTypes['CreateExperienceError'][] | null; // [CreateExperienceError!]
  ...
  InvalidOrganizationError: { // root type
    message: string; // String!
  }
  ...
  RemoveSkillPayload: { // root type
    errors?: NexusGenRootTypes['RemoveSkillError'][] | null; // [RemoveSkillError!]
    record?: NexusGenRootTypes['Skill'] | null; // Skill
  }
  ...
  UpdateExperiencePayload: { // root type
    errors?: NexusGenRootTypes['UpdateExperienceError'][] | null; // [UpdateExperienceError!]
    record?: NexusGenRootTypes['Experience'] | null; // Experience
  }
...
export interface NexusGenFieldTypes {
  ...
  InvalidOrganizationError: { // field return type
    message: string; // String!
    path: string[]; // [String!]!
  }
  ...
  Mutation: { // field return type
    ...
    removeDesiredSkill: NexusGenRootTypes['RemoveDesiredSkillPayload']; // RemoveDesiredSkillPayload!
    removePostThumbnail: NexusGenRootTypes['RemovePostThumbnailPayload']; // RemovePostThumbnailPayload!
    removeSkill: NexusGenRootTypes['RemoveSkillPayload']; // RemoveSkillPayload!
  ...
  RemoveSkillPayload: { // field return type
    errors: NexusGenRootTypes['RemoveSkillError'][] | null; // [RemoveSkillError!]
    query: NexusGenRootTypes['Query']; // Query!
    record: NexusGenRootTypes['Skill'] | null; // Skill
    viewer: NexusGenRootTypes['User'] | null; // User
  ...
  SkillNotFoundError: { // field return type
    message: string; // String!
    path: string[]; // [String!]!
  }
  ...
  Connection: { // field return type
    edges: NexusGenRootTypes['ConnectionEdge'][]; // [ConnectionEdge!]!
  ...
  CreateExperienceError: { // field return type
    message: string; // String!
    path: string[]; // [String!]!
  }
  ...
  RemoveDesiredSkillError: { // field return type
    message: string; // String!
    path: string[]; // [String!]!
  }
  RemoveSkillError: { // field return type
    message: string; // String!
    path: string[]; // [String!]!
  }
  ...
  UpdateExperienceError: { // field return type
    message: string; // String!
    path: string[]; // [String!]!
  }
...
export interface NexusGenFieldTypeNames {
  ...
  InvalidOrganizationError: { // field return type name
    message: 'String'
    path: 'String'
  }
  ...
  Mutation: { // field return type name
    ...
    removeDesiredSkill: 'RemoveDesiredSkillPayload'
    removePostThumbnail: 'RemovePostThumbnailPayload'
    removeSkill: 'RemoveSkillPayload'
  ...
  RemoveSkillPayload: { // field return type name
    errors: 'RemoveSkillError'
    query: 'Query'
    record: 'Skill'
    viewer: 'User'
  }
  ...
  SkillNotFoundError: { // field return type name
    message: 'String'
    path: 'String'
  }
  ...
  CreateExperienceError: { // field return type name
    message: 'String'
    path: 'String'
  }
  ...
  RemoveDesiredSkillError: { // field return type name
    message: 'String'
    path: 'String'
  }
  RemoveSkillError: { // field return type name
    message: 'String'
    path: 'String'
  }
  ...
  UpdateExperienceError: { // field return type name
    message: 'String'
    path: 'String'
  }
...
export interface NexusGenTypeInterfaces {
  ...
  SkillNotFoundError: "MutationError" | "RemoveDesiredSkillError" | "RemoveSkillError"
